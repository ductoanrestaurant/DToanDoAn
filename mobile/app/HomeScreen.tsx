            ...
            <View>
                ...
                <TouchableOpacity style={styles.locationContainer}>
                    <Text style={styles.headerLocationText} numberOfLines={1}>
                        {customerInfo ? customerInfo.tenKhachHang : 'Khách hàng'}
                    </Text>
                </TouchableOpacity>
            </View>
    ...
    const renderBottomNavBar = () => (
        <View style={styles.bottomNavWrapper}>
            ...
            <View style={styles.centerActionContainer}>
                <TouchableOpacity style={styles.centerButton} onPress={() => router.push('/dat-ban')} activeOpacity={0.9}><MaterialCommunityIcons name="table-chair" size={28} color={COLORS.white} /></TouchableOpacity>
