...
const AddGiamGiaPage = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            // Step 1: Create the discount by sending JSON data
            const discountData = {
                code,
                moTa,
                giaTri,
            ...
            // Step 2: If there is a file, upload it
            if (file && discountId) {
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            ...
                            <input
                                ...
                                required
                                className="w-full px-4 py-3 rounded-xl border border-gray-300 bg-gray-50 focus:ring-2 focus:ring-blue-500 outline-none transition-all"
                            />
                        </div>
                        <div>
